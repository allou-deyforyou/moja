...
const AccountSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'transaction': PropertySchema(
      ...
      name: r'transaction',
      type: IsarType.string,
      enumMap: _AccounttransactionEnumValueMap,
    )
  },
...
int _accountEstimateSize(
  ...
  {
    final value = object.transaction;
    if (value != null) {
...
void _accountSerialize(
  ...
  writer.writeString(offsets[4], object.transaction?.name);
}
...
Account _accountDeserialize(
  ...
  final object = Account(
    ...
    transaction:
        _AccounttransactionValueEnumMap[reader.readStringOrNull(offsets[4])],
  );
  return object;
}
...
P _accountDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readString(offset)) as P;
    case 4:
      return (_AccounttransactionValueEnumMap[reader.readStringOrNull(offset)])
          as P;
    default:
...
const _AccounttransactionEnumValueMap = {
  r'cashin': r'cashin',
  r'cashout': r'cashout',
};
const _AccounttransactionValueEnumMap = {
  r'cashin': Transaction.cashin,
  r'cashout': Transaction.cashout,
};
...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> amountIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> amountIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> imageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'transaction',
      ));
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionEqualTo(
    Transaction? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionGreaterThan(
    Transaction? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionLessThan(
    Transaction? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionBetween(
    Transaction? lower,
    Transaction? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> transactionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'transaction',
        value: '',
...
extension AccountQuerySortBy on QueryBuilder<Account, Account, QSortBy> {
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByImageDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByTransaction() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'transaction', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByTransactionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQuerySortThenBy
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.desc);
    });
  }
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByTransaction() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'transaction', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByTransactionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'transaction', Sort.desc);
    });
  }
...
extension AccountQueryWhereDistinct
  ...
  QueryBuilder<Account, Account, QDistinct> distinctByTransaction(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQueryProperty
  ...
  QueryBuilder<Account, String, QQueryOperations> imageProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Transaction?, QQueryOperations> transactionProperty() {
    return QueryBuilder.apply(this, (query) {
